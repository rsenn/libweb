...
function Timer(timeout, fn, props = {}, {
  create = setInterval,
...
Timer.interval = (timeout, fn, props) => new Timer(timeout, fn, props, {
  destroy: clearTimeout
});

Timer.once = (timeout, fn, props) => new Timer(timeout, fn, props, {
  create: setTimeout,
  destroy: clearTimeout
});
...
Timer.promise = (timeout, impl = Timer.std) => new Promise((resolve, reject) => Timer(timeout, resolve, {}, {
