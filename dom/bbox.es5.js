...
var BBox = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(BBox, [{
    ...
    value: function transform() {
      var fn = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : function (arg) {
        return arg;
      };
    ...
    value: function from(iter) {
      var tp = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function (p) {
        return p;
      };
      return function () {
