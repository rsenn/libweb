...
var _node.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js = require("./node.js");

var _trbl.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js = require("./trbl.js");

var _rect.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js = require("./rect.js");
...
var Element = /*#__PURE__*/function (_Node) {
  ...
  (0, _createClass2["default"])(Element, null, [{
    ...
    value: function create() {
      ...
      var _ref = typeof args[0] == "object" ? args.shift() : _objectSpread({
        tagName: args.shift()
      }, args.shift()),
      ...
      if (children && children.length) children.forEach(function (obj) {
    ...
    value: function toObject(elem) {
      ...
      var children = opts.children ? e.children && e.children.length ? {
        children: _util["default"].array(e.children).map(function (child) {
          return Element.toObject(child, e);
        })
      } : {} : {};
      var ns = (arguments[1] ? arguments[1].namespaceURI : document.body.namespaceURI) != e.namespaceURI ? {
        ns: e.namespaceURI
      } : {};
      var attributes = {};
    ...
    value: function toCommand(elem) {
      ...
      s += "Element.create('".concat(tagName, "', { ").concat((0, _entries["default"])(attrs).map(function (_ref2) {
        var _ref3 = (0, _slicedToArray2["default"])(_ref2, 2),
            k = _ref3[0],
            v = _ref3[1];

        return "".concat(k, ": ").concat((0, _stringify["default"])(v));
      }).join(", "), " }").concat(parent ? ", ".concat(parent) : "", ");");
      var child;
    ...
    value: function getCSS(element) {
          ...
          if (typeof result == "object") {
            try {
              (0, _defineProperty2["default"])(result, "cssText", {
                get: function get() {
                  return (0, _entries["default"])(this).map(function (_ref9) {
      ...
      if (property !== undefined) {
        ret = typeof property === "string" ? style[property] : property.reduce(function (ret, key) {
          ret[key] = style[key];
          return ret;
        }, {});
      } else {
    ...
    value: function dump(elem) {
      ...
      str = dumpElem(elem, "");
      str = Element.walk(elem.firstElementChild, function (e, a, r, d) {
    ...
    value: function skipper(fn) {
      var pred = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function (a, b) {
    ...
    value: function factory() {
      ...
      if (!delegate.create) delegate.create = function (tag) {
  ...
  return _regenerator["default"].wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          tfn = _args.length > 1 && _args[1] !== undefined ? _args[1] : function (e) {
            return e;
          };
  ...
  return _regenerator["default"].wrap(function _callee2$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          tfn = _args2.length > 1 && _args2[1] !== undefined ? _args2[1] : function (e) {
            return e;
          };
          if (typeof elem == "string") elem = Element.find(elem);
          root = elem;
