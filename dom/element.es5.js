...
class Element extends _node.Node {
    ...
    s += "Element.create('"
      ...
      .concat(
        Object.entries(attrs)
          .map(([k, v]) => "".concat(k, ": ").concat(JSON.stringify(v)))
          .join(", "),
        " }"
      )
  ...
  static getCSS(element, property = undefined, receiver = null) {
    ...
    const pstyle = parent && parent.tagName ? _util.default.toHash(w && w.getComputedStyle ? w.getComputedStyle(parent) : d.getComputedStyle(parent)) : {};
            ...
            Object.defineProperty(result, "cssText", {
              get: function get() {
                return Object.entries(this)
                  .map(([k, v]) => "".concat(_util.default.decamelize(k, "-"), ": ").concat(v, ";\n"))
                  .join("");
              },
              enumerable: false
            });
