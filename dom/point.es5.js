...
Point.prototype.round = function() {
  var precision = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0.001;
  var prec = -Math.ceil(Math.log10(precision));
...
Point.prototype.toString = function() {
  var precision = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0.001;
  var prec = -Math.ceil(Math.log10(precision));
  var x = this.x.toFixed(prec);
  var y = this.y.toFixed(prec);
...
Point.fromAngle = function(angle, f) {
  return Point.prototype.fromAngle.call(new Point(0, 0), angle, f);
};
