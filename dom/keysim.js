  ...
  dispatchModifierStateTransition(target, fromModifierState, toModifierState, events = KeyEvents.ALL) {
    ...
    if(includeKeyUp && didHaveMeta === true && willHaveMeta === false) {
      ...
      target.dispatchEvent(
        this.createEventFromKeystroke('keyup', new Keystroke(currentModifierState, this._actionKeyCodeMap.META), target)
      );
    }
    ...
    if(includeKeyUp && didHaveCtrl === true && willHaveCtrl === false) {
      ...
      target.dispatchEvent(
        this.createEventFromKeystroke('keyup', new Keystroke(currentModifierState, this._actionKeyCodeMap.CTRL), target)
      );
    }
    ...
    if(includeKeyUp && didHaveAlt === true && willHaveAlt === false) {
      ...
      target.dispatchEvent(
        this.createEventFromKeystroke('keyup', new Keystroke(currentModifierState, this._actionKeyCodeMap.ALT), target)
      );
    }
