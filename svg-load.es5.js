...
var _axios.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js.es5.js = _interopRequireDefault(require("./axios.es5.js"));
    ...
    value: function put(url, data) {
      if (this.instace !== null) {
        this.instance.then(function (cache) {
          return cache.put(url, new Response(data, {
            headers: {
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          _context2.next = 7;
          return _regenerator["default"].awrap(_axios["default"].get(url).then(function (response) {
