...
export function useIterator  (iterator) {
    var initialState = useMemo(function () { return iterator.next(); }, []);
    var _a = useReducer(reducer, initialState), result = _a[0], dispatch = _a[1];
    var next = useCallback(function (next) {
        var res = iterator.next(next);
        dispatch(res);
    }, [iterator, dispatch]);
    var return_ = useCallback(function (value) {
        var _a;
    ...
    var throw_ = useCallback(function (error) {
        var _a;
