...
import { useReducer, useCallback, useMemo } from '../dom/preactComponent.js';
  ...
  var next = useCallback(
    function(arg) {
      ...
      void asyncIterator
        .next(arg)
        .then(function (r) {
          return update({ value: r.value, done: r.done });
        })
    ...
    function(value) {
      return __awaiter(void 0, void 0, void 0, function() {
        ...
        return __generator(this, function(_b) {
          update({ loading: true });
          void ((_a = asyncIterator.return) === null || _a === void 0
            ? void 0
            : _a
                .call(asyncIterator, value)
                .then(function (r) {
                  return update({ value: r.value, done: r.done });
                })
                .catch(function (error) {
  ...
  var throw_ = useCallback(
    function(value) {
      return __awaiter(void 0, void 0, void 0, function() {
        ...
        return __generator(this, function(_b) {
          update({ loading: true });
          void ((_a = asyncIterator.throw) === null || _a === void 0
            ? void 0
            : _a
                .call(asyncIterator, value)
                .then(function (r) {
