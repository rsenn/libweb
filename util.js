...
Util.timer = msecs => {
  ...
  timer = {
    ...
    get created() { return createdTime; },
    get start() { return startTime || new Date(endTime.valueOf() - delay); },
    get stop() { return stopTime instanceof Date ? stopTime : undefined; },
    get elapsed() { return delay  + (stopTime || new Date()).valueOf() - endTime.valueOf(); },
    get end() {return endTime; },
    get remain() {return endTime.valueOf() - (stopTime || new Date()).valueOf(); },
    cancel() {
      log('cancel', this);
      clearTimeout(id);
      finish();
