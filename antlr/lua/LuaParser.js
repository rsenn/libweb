...
LuaParser.prototype.retstat = function() {
  ...
  try {
    ...
    _la = this._input.LA(1);
    if(
      ((_la & ~0x1f) == 0 && ((1 << _la) & ((1 << LuaParser.T__16) | (1 << LuaParser.T__22) | (1 << LuaParser.T__23) | (1 << LuaParser.T__24) | (1 << LuaParser.T__25) | (1 << LuaParser.T__26) | (1 << LuaParser.T__30))) !== 0) ||
      (((_la - 43) & ~0x1f) == 0 &&
        ((1 << (_la - 43)) &
          ((1 << (LuaParser.T__42 - 43)) |
            (1 << (LuaParser.T__49 - 43)) |
            (1 << (LuaParser.T__52 - 43)) |
            (1 << (LuaParser.T__53 - 43)) |
            (1 << (LuaParser.NAME - 43)) |
            (1 << (LuaParser.NORMALSTRING - 43)) |
            (1 << (LuaParser.CHARSTRING - 43)) |
            (1 << (LuaParser.LONGSTRING - 43)) |
            (1 << (LuaParser.INT - 43)) |
            (1 << (LuaParser.HEX - 43)) |
            (1 << (LuaParser.FLOAT - 43)) |
            (1 << (LuaParser.HEX_FLOAT - 43)))) !==
          0)
    ) {
      this.state = 166;
      this.explist();
...
LuaParser.prototype.tableconstructor = function() {
  ...
  try {
    ...
    _la = this._input.LA(1);
    if(
      ((_la & ~0x1f) == 0 && ((1 << _la) & ((1 << LuaParser.T__16) | (1 << LuaParser.T__22) | (1 << LuaParser.T__23) | (1 << LuaParser.T__24) | (1 << LuaParser.T__25) | (1 << LuaParser.T__26) | (1 << LuaParser.T__28) | (1 << LuaParser.T__30))) !== 0) ||
      (((_la - 43) & ~0x1f) == 0 &&
        ((1 << (_la - 43)) &
          ((1 << (LuaParser.T__42 - 43)) |
            (1 << (LuaParser.T__49 - 43)) |
