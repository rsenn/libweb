  ...
  normalizeName = (function () {
    ...
    return function(propName) {
      return (propName = (propName + '')
        .replace(/\s/g, '')
        .replace(/-([\da-z])/gi, function(str, p1) {
  ...
  cssSupports = (function () {
    return (
      ...
      function(propName, propValue) {
        ...
        return (
          declaration[propName] != null && // Because getPropertyValue returns '' if it is unsupported
...
function getName(propName) {
  ...
  if(propName && propNames[propName] == null) {
    ...
    if(declaration[propName] != null) {
      ...
      if(
        !NAME_PREFIXES.some(function (prefix) {
...
function getValue(propName, propValue) {
  ...
  (Array.isArray(propValue) ? propValue : [propValue]).some(function (propValue) {
    ...
    if(
      VALUE_PREFIXES.some(function (prefix) {
        // Try with prefixes
