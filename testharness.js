...
(function (global_scope) {
  ...
  function promise_test(func, name, properties) {
    ...
    tests.promise_tests = tests.promise_tests.then(function () {
      return new Promise(function (resolve) {
        ...
        test.step(function () {
          assert(!!promise, 'promise_test', null, "test body must return a 'thenable' object (received ${value})", { value: promise });
  ...
  function assert_equals(actual, expected, description) {
    ...
    assert(same_value(actual, expected), 'assert_equals', description, 'expected ${expected} but got ${actual}', { expected: expected, actual: actual });
  }
  ...
  function assert_not_equals(actual, expected, description) {
    assert(!same_value(actual, expected), 'assert_not_equals', description, 'got disallowed value ${actual}', { actual: actual });
  }
  ...
  function assert_in_array(actual, expected, description) {
    assert(expected.indexOf(actual) != -1, 'assert_in_array', description, 'value ${actual} not in array ${expected}', { actual: actual, expected: expected });
  }
  ...
  function assert_object_equals(actual, expected, description) {
    ...
    function check_equal(actual, expected, stack) {
      ...
      for(p in expected) {
        assert(actual.hasOwnProperty(p), 'assert_object_equals', description, 'expected property ${p} missing', { p: p });
      }
      stack.pop();
    }
  ...
  function assert_array_equals(actual, expected, description) {
    ...
    for(var i = 0; i < actual.length; i++) {
      ...
      assert(
        ...
        { i: i, expected: expected[i], actual: actual[i], arrayExpected: shorten_array(expected, i), arrayActual: shorten_array(actual, i) },
      );
    }
  }
  ...
  function assert_less_than(actual, expected, description) {
     ...
     */
    assert(typeof actual === 'number', 'assert_less_than', description, 'expected a number but got a ${type_actual}', { type_actual: typeof actual });
  ...
  function assert_regexp_match(actual, expected, description) {
     ...
     */
    assert(expected.test(actual), 'assert_regexp_match', description, 'expected ${expected} but got ${actual}', { expected: expected, actual: actual });
  }
  ...
  function assert_class_string(object, class_string, description) {
    ...
    assert(same_value(actual, expected), 'assert_class_string', description, 'expected ${expected} but got ${actual}', { expected: expected, actual: actual });
  }
  ...
  function assert_own_property(object, property_name, description) {
    assert(object.hasOwnProperty(property_name), 'assert_own_property', description, 'expected property ${p} missing', { p: property_name });
  }
  ...
  function _assert_inherits(name) {
    return function(object, property_name, description) {
      ...
      assert(property_name in object, name, description, 'property ${p} not found in prototype chain', { p: property_name });
    };
  }
  ...
  function assert_readonly(object, property_name, description) {
    assert(property_name in object, 'assert_readonly', description, 'property ${p} not found', { p: property_name });
    ...
    assert(desc !== undefined, 'assert_readonly', description, 'could not find a descriptor for property ${p}', { p: property_name });
  ...
  function assert_throws_js_impl(constructor, func, description, assertion_type) {
    try {
      ...
      assert(typeof constructor == 'function', assertion_type, description, '${constructor} is not a constructor', { constructor: constructor });
      var obj = constructor;
      while(obj) {
      ...
      assert(obj != null, assertion_type, description, '${constructor} is not an Error subtype', { constructor: constructor });
      ...
      assert(
        ...
        { func: func, actual: e, actual_name: e.name, expected: constructor, expected_name: constructor.name },
      );
    }
  }
  ...
  Output.prototype.show_results = function(tests, harness_status, asserts_run) {
    ...
    var summary_template = [
      ...
      function() {
        ...
        var rv = [['section', {}, ['p', {}, 'Harness status: ', ['span', { class: status_class(status) }, status]], ['button', { id: 'rerun' }, 'Rerun']]];
    ...
    const section = render([
      ...
      [
        ...
        ['thead', {}, ['tr', {}, ['th', {}, 'Result'], ['th', {}, 'Test Name'], assertions ? ['th', {}, 'Assertion'] : '', ['th', {}, 'Message']]],
        ['tbody', {}],
      ],
    ]);
