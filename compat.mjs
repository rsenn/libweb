...
import {
  ...
  createRef as b,
  createContext as _
} from './dom/preactComponent.js';
export { createElement, createContext, createRef, Fragment, Component } from './dom/preactComponent.js';
function S(n, t) {
...
function g(n, t) {
  ...
  return (
    (r.displayName = 'Memo(' + (n.displayName || n.name) + ')'), (r.prototype.isReactComponent = !0), (r.__f = !0), r
  );
}
...
h.event = function(n) {
  return (
    H && (n = H(n)), (n.persist = Z), (n.isPropagationStopped = Y), (n.isDefaultPrevented = $), (n.nativeEvent = n)
  );
};
var q,
  G = {
