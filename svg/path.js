...
export class SvgPath {
  ...
  bezier3(x1, y1, x2, y2, x, y) {
    ...
    if(!shortcut) return this._cmd('C')(p1.x, p1.y, p2.x, p2.y, end.x, end.y);
...
commands.forEach(commandName => {
  Object.defineProperty(SvgPath.prototype, commandName, {
    value: function(...args) {
      this.commands.push(new Command(commandName, ...args));
      return this;
    },
  });
});
