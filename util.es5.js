...
Util.define = (obj, key, value, enumerable = false) => obj[key] === undefined && Object.defineProperty(obj, key, {
  enumerable,
  configurable: false,
  writable: false,
  value
...
Util.mergeLists = function (arr1, arr2, key = "id") {
  let hash = arr1.reduce((acc, it) => Object.assign({
    [it[key]]: it
  }, acc), {});
  hash = arr2.reduce((acc, it) => Object.assign({
    [it[key]]: it
  }, acc), {});
  let ret = Util.array();
  ...
  return _regenerator.default.mark(function _callee7() {
    ...
    return _regenerator.default.wrap(function _callee7$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
        case 0:
          _context9.t0 = _regenerator.default.keys(obj);
    ...
    }, _callee7, null, [[11, 23, 27, 35], [28,, 30, 34], [39, 75, 79, 87], [46, 58, 62, 70], [63,, 65, 69], [80,, 82, 86]]);
  })();
};
...
Util.walkTree = function (node, pred, t, depth = 0, parent = null) {
  return _regenerator.default.mark(function _callee8() {
    var _i, _arr, child;
    ...
    return _regenerator.default.wrap(function _callee8$(_context10) {
      while (1) switch (_context10.prev = _context10.next) {
        ...
        case 7:
          ...
          child = _arr[_i];
          return _context10.delegateYield(Util.walkTree(child, pred, t, depth + 1, node.parent_id), "t0", 10);
