...
export class Functional {
  ...
  static unary = (fn) => function (a) {
    return fn.apply(null, arguments);
  };

  static binary = (fn) => function (a, b) {
    return fn.apply(null, arguments);
  };

  static ternary = (fn) => function (a, b, c) {
    return fn.apply(null, arguments);
  };
  ...
  static compose() {
    ...
    return Functional.ncurry(
      ...
      true,
      Functional.fold1(fs, (f, g) => function () {
        let as;
        as = 1 <= arguments.length ? slice1.call(arguments, 0) : [];
  ...
  static pipe() {
    ...
    fn = this.foldr1(fs, (f, g) => function () {
      let as;
      as = 1 <= arguments.length ? slice1.call(arguments, 0) : [];
      return f(g.apply(null, as));
    });
  ...
  static apply = (fn) => function (as) {
    return fn.apply(null, as);
  };

  static unapply = (fn) => function () {
    let as;
    as = 1 <= arguments.length ? slice1.call(arguments, 0) : [];
    return fn(as);
  };
  ...
  static evolve = this.curry2((o, t) => this.omap(o, (k, v) => {
    if (this.has(t, k)) {
      return t[k](v);
    }
    return v;
  ...
  static comp = (f) => this.unary(function () {
    let as;
    as = 1 <= arguments.length ? slice1.call(arguments, 0) : [];
    return !f.apply(null, as);
  });
