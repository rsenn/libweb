/**
 * @format
 * @fileoverview - Using the 'QRCode for Javascript library' - Fixed dataset of 'QRCode for Javascript library' for support full-spec. - this library has no dependencies.
 * @author davidshimjs
...
(function () {
  ...
  QRCode.prototype.makeCode = function(sText) {
    this._oQRCode = new QRCodeModel(_getTypeNumber(sText, this._htOption.correctLevel),
