...
export default function toSource(object,
  replacer = a => a,
  indent = '  ',
  startingIndent = ''
) {
  ...
  function walk(object, replacer = a => a, indent, currentIndent, seen) {
    ...
    if(object instanceof Set) {
      return `new Set(${walk(Array.from(object.values()),
        replacer,
        indent,
        nextIndent,
        seen
    ...
    if(object instanceof Map) {
      return `new Map(${walk(Array.from(object.entries()),
        replacer,
        indent,
        nextIndent,
        seen
    ...
    if(Array.isArray(object)) {
      return `[${join(object.map(element =>
