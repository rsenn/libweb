...
function p$1(n$$1, r, o) {
  var i = v$1(t$1++, 2);
  return i.t = n$$1, i.__c || (i.__ = [o ? o(r) : k$1(void 0, r), function (n$$1) {
...
n.__r = function (n$$1) {
  ...
  f$1 && f$1(t);
  var u = t.__c;
  u && u.__H && u.__H.__h.length && (1 !== i$1.push(u) && r$1 === n.requestAnimationFrame || ((r$1 = n.requestAnimationFrame) || function (n$$1) {
    var t,
        u = function () {
  ...
  u.some(function (t) {
    try {
      t.__h.forEach(b$1), t.__h = t.__h.filter(function (n$$1) {
...
function j$1(n$$1, t) {
  return !n$$1 || n$$1.length !== t.length || t.some(function (t, u) {
    return t !== n$$1[u];
  });
}
