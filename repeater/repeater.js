      ...
      try {
        for (var _e = __values(this.pullQueue), _f = _e.next(); !_f.done; _f = _e.next()) {
          ...
          let execution =
            this.pending === undefined
              ? this.consume()
              : this.pending.then(() => _this.consume());
    ...
    return __generator(this, (_b) => {
      ...
      case 7:
        ...
        return [
          4 /*yield*/,
          Promise.race(
            iters.map((iter) => iter.return && iter.return())
          )
        ];
      case 8:
        _b.sent();
    ...
    return __generator(this, (_a) => {
      ...
      case 0:
        ...
        return [
          4 /*yield*/,
          Promise.all(
            iters.map((iter) => __awaiter(_this, void 0, void 0, function () {
              let result, _a;
              return __generator(this, (_b) => {
                switch (_b.label) {
                case 0:
  ...
  return new Repeater((push, stop) => __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, (_a) => {
      ...
      case 2:
        ...
        if (
          results_2.every((result) => result.done)
        ) {
      ...
      case 3:
        ...
        return [
          4 /*yield*/,
          Promise.all(
            iters.map((iter, i) => __awaiter(_this, void 0, void 0, function () {
              let result;
              return __generator(this, (_a) => {
                switch (_a.label) {
                case 0:
