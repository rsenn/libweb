...
exports[
  "default"
] = exports.RandomColor = exports.TransitionList = exports.Transition = exports.CSSTransformSetters = exports.ElementTransformation = exports.ElementRectProps = exports.ElementSizeProps = exports.ElementPosProps = exports.ElementWHProps = exports.ElementXYProps = exports.Select = exports.Renderer = exports.ReactComponent = exports.Container = exports.Anchor = exports.isNumber = void 0;
...
var _jsxFileName = "/home/roman/the-wild-beauty-company/lib/dom.es5.js",
  _Object$assign2;
...
var SvgPath = require("./svg-path.es5.js");
...
ElementRectProxy.prototype = {
  ...
  getRect: function getRect() {
    ...
    return fn(
      _element.Element.rect(this.element, {
        round: false
      })
    );
  },
...
var computedSetter = function computedSetter(proxy, compute) {
  return function(value) {
    ...
    r = compute(value, r);
    if(r && r.x !== undefined)
      proxy.setRect(function(oldrect) {
        return r;
      });
    return r;
  };
...
var _default = (0, _assign["default"])(
  ...
  (0, _defineProperty3["default"])(_Object$assign2, "HSLA", _hsla.HSLA),
  (0, _defineProperty3["default"])(_Object$assign2, "Select", Select),
  (0, _defineProperty3["default"])(_Object$assign2, "Size", _size.Size),
  (0, _defineProperty3["default"])(_Object$assign2, "SVG", _svg.SVG),
  (0, _defineProperty3["default"])(_Object$assign2, "Timer", _timer.Timer),
  (0, _defineProperty3["default"])(_Object$assign2, "Transition", Transition),
  (0, _defineProperty3["default"])(_Object$assign2, "TransitionList", TransitionList),
  (0, _defineProperty3["default"])(_Object$assign2, "TRBL", _trbl.TRBL),
  (0, _defineProperty3["default"])(_Object$assign2, "Tree", _tree.Tree),
  _Object$assign2)
);
