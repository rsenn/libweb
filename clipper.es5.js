(function () {
  ...
  ClipperLib.FPoint1 = function (pt) {
    ...
    if (ClipperLib.use_xyz) {
      if (typeof pt.Z === "undefined") this.Z = 0;else this.Z = pt.Z;
    }
  };
  ...
  ClipperLib.ClipperBase.prototype.RangeTest = function (pt) {
    if (pt.X > ClipperLib.ClipperBase.maxValue || pt.X < -ClipperLib.ClipperBase.maxValue || pt.Y > ClipperLib.ClipperBase.maxValue || pt.Y < -ClipperLib.ClipperBase.maxValue || pt.X > 0 && pt.X < ClipperLib.ClipperBase.minValue || pt.Y > 0 && pt.Y < ClipperLib.ClipperBase.minValue || pt.X < 0 && pt.X > -ClipperLib.ClipperBase.minValue || pt.Y < 0 && pt.Y > -ClipperLib.ClipperBase.minValue) ClipperLib.Error("Coordinate outside allowed range in RangeTest().");
  };
  ...
  ClipperLib.ClipperBase.prototype.AddPath = function (pg, polyType, Closed) {
    ...
    for (;;) {
      ...
      if (E.Prev === E.Next) break;else if (Closed && ClipperLib.ClipperBase.SlopesEqual4(E.Prev.Curr, E.Curr, E.Next.Curr) && (!this.PreserveCollinear || !this.Pt2IsBetweenPt1AndPt3(E.Prev.Curr, E.Curr, E.Next.Curr))) {
        if (E === eStart) eStart = E.Next;
        E = this.RemoveEdge(E);
        E = E.Prev;
        eLoopStop = E;
  ...
  ClipperLib.ClipperBase.prototype.Pt2IsBetweenPt1AndPt3 = function (pt1, pt2, pt3) {
    if (ClipperLib.FPoint.op_Equality(pt1, pt3) || ClipperLib.FPoint.op_Equality(pt1, pt2) || ClipperLib.FPoint.op_Equality(pt3, pt2)) return false;else if (pt1.X !== pt3.X) return pt2.X > pt1.X === pt2.X < pt3.X;else return pt2.Y > pt1.Y === pt2.Y < pt3.Y;
  };
  ...
  ClipperLib.Clipper.prototype.ExecuteInternal = function () {
    try {
      ...
      for (i = 0, ilen = this.m_PolyOuts.length; i < ilen; i++) {
        outRec = this.m_PolyOuts[i];
        if (outRec.Pts === null) continue;else if (outRec.IsOpen) this.FixupOutPolyline(outRec);else this.FixupOutPolygon(outRec);
      }
  ...
  ClipperLib.Clipper.prototype.SetZ = function (pt, e1, e2) {
    if (this.ZFillFunction !== null) {
      if (pt.Z !== 0 || this.ZFillFunction === null) return;else if (ClipperLib.FPoint.op_Equality(pt, e1.Bot)) pt.Z = e1.Bot.Z;else if (ClipperLib.FPoint.op_Equality(pt, e1.Top)) pt.Z = e1.Top.Z;else if (ClipperLib.FPoint.op_Equality(pt, e2.Bot)) pt.Z = e2.Bot.Z;else if (ClipperLib.FPoint.op_Equality(pt, e2.Top)) pt.Z = e2.Top.Z;else this.ZFillFunction(e1.Bot, e1.Top, e2.Bot, e2.Top, pt);
    }
  };
  ...
  ClipperLib.Clipper.prototype.AddOutPt = function (e, pt) {
    if (e.OutIdx < 0) {
      ...
      if (ToFront && ClipperLib.FPoint.op_Equality(pt, op.Pt)) return op;else if (!ToFront && ClipperLib.FPoint.op_Equality(pt, op.Prev.Pt)) return op.Prev;
      var newOp = new ClipperLib.OutPt();
      newOp.Idx = outRec.Idx;
      newOp.Pt.X = pt.X;
      newOp.Pt.Y = pt.Y;
  ...
  ClipperLib.Clipper.prototype.SetHoleState = function (e, outRec) {
    ...
    while (e2 !== null) {
      if (e2.OutIdx >= 0 && e2.WindDelta !== 0) {
        if (eTmp === null) eTmp = e2;else if (eTmp.OutIdx === e2.OutIdx) eTmp = null;
      }
  ...
  ClipperLib.Clipper.prototype.AppendPolygon = function (e1, e2) {
    ...
    var holeStateRec;
    if (this.OutRec1RightOfOutRec2(outRec1, outRec2)) holeStateRec = outRec2;else if (this.OutRec1RightOfOutRec2(outRec2, outRec1)) holeStateRec = outRec1;else holeStateRec = this.GetLowermostRec(outRec1, outRec2);
  ...
  ClipperLib.Clipper.prototype.IntersectEdges = function (e1, e2, pt) {
    ...
    if (ClipperLib.use_lines) {
      if (e1.WindDelta === 0 || e2.WindDelta === 0) {
        if (e1.WindDelta === 0 && e2.WindDelta === 0) return;else if (e1.PolyTyp === e2.PolyTyp && e1.WindDelta !== e2.WindDelta && this.m_ClipType === ClipperLib.ClipType.ctUnion) {
            if (e1.WindDelta === 0) {
              if (e2Contributing) {
                this.AddOutPt(e1, pt);
  ...
  ClipperLib.Clipper.prototype.ProcessHorizontal = function (horzEdge) {
    ...
    for (;;) {
      ...
      while (e !== null) {
        ...
        if (horzEdge.OutIdx >= 0 && !IsOpen) {
          if (ClipperLib.use_xyz) {
            if (dir === ClipperLib.Direction.dLeftToRight) this.SetZ(e.Curr, horzEdge, e);else this.SetZ(e.Curr, e, horzEdge);
          }
  ...
  ClipperLib.Clipper.prototype.IntersectPoint = function (edge1, edge2, ip) {
    ...
    if (edge1.Delta.X === 0) {
      ...
      ip.Y = q;
      if (Math.abs(edge1.Dx) < Math.abs(edge2.Dx)) ip.X = edge1.Dx * q + b1;else ip.X = edge2.Dx * q + b2;
    }
  ...
  ClipperLib.Clipper.prototype.ProcessEdgesAtTopOfScanbeam = function (topY) {
    ...
    while (e !== null) {
      ...
      if (IsMaximaEdge) {
        ...
        if (ClipperLib.use_xyz) {
          if (e.Top.Y === topY) e.Curr.Z = e.Top.Z;else if (e.Bot.Y === topY) e.Curr.Z = e.Bot.Z;else e.Curr.Z = 0;
        }
  ...
  ClipperLib.Clipper.prototype.FixupFirstLefts2 = function (innerOutRec, outerOutRec) {
    ...
    for (var i = 0, ilen = this.m_PolyOuts.length; i < ilen; i++) {
      ...
      if (this.Poly2ContainsPoly1(outRec.Pts, innerOutRec.Pts)) outRec.FirstLeft = innerOutRec;else if (this.Poly2ContainsPoly1(outRec.Pts, outerOutRec.Pts)) outRec.FirstLeft = outerOutRec;else if (outRec.FirstLeft === innerOutRec || outRec.FirstLeft === outerOutRec) outRec.FirstLeft = orfl;
    }
  };
  ...
  ClipperLib.Clipper.prototype.JoinCommonEdges = function () {
    for (var i = 0, ilen = this.m_Joins.length; i < ilen; i++) {
      ...
      var holeStateRec;
      if (outRec1 === outRec2) holeStateRec = outRec1;else if (this.OutRec1RightOfOutRec2(outRec1, outRec2)) holeStateRec = outRec2;else if (this.OutRec1RightOfOutRec2(outRec2, outRec1)) holeStateRec = outRec1;else holeStateRec = this.GetLowermostRec(outRec1, outRec2);
  ...
  ClipperLib.ClipperOffset.prototype.AddPath = function (path, joinType, endType) {
    ...
    for (var i = 1; i <= highI; i++) if (ClipperLib.FPoint.op_Inequality(newNode.m_polygon[j], path[i])) {
      j++;
    ...
    if (this.m_lowest.X < 0) this.m_lowest = new ClipperLib.FPoint2(this.m_polyNodes.ChildCount() - 1, k);else {
  ...
  ClipperLib.ClipperOffset.prototype.DoOffset = function (delta) {
    ...
    for (var i = 0; i < this.m_polyNodes.ChildCount(); i++) {
      ...
      if (node.m_endtype === ClipperLib.EndType.etClosedLine || node.m_endtype === ClipperLib.EndType.etClosedPolygon) this.m_normals.push(ClipperLib.ClipperOffset.GetUnitNormal(this.m_srcPoly[len - 1], this.m_srcPoly[0]));else this.m_normals.push(new ClipperLib.FPoint1(this.m_normals[len - 2]));
  ...
  ClipperLib.JS.Lighten = function (polygon, tolerance) {
    ...
    for (i = 0; i < len; i++) {
      ...
      for (k = 0; k < 1000000; k++) {
        ...
        if (addlast) poly.pop();
        if (!rem.length) break;else poly = poly2;
      }
